...
--
-- Host: localhost
-- Generation Time: Aug 24, 2016 at 04:50 AM
...
CREATE TABLE `qb_account` (
  ...
  `TimeModified` varchar(40) DEFAULT NULL,
  `EditSequence` text,
  ...
  `qbsql_discov_datetime` varchar(40) DEFAULT NULL,
  `qbsql_resync_datetime` varchar(40) DEFAULT NULL,
  ...
  `qbsql_enqueue_datetime` varchar(40) DEFAULT NULL,
  `qbsql_dequeue_datetime` varchar(40) DEFAULT NULL,
  `qbsql_audit_amount` decimal(10,0) DEFAULT NULL,
  `qbsql_audit_modified` varchar(40) DEFAULT NULL,
...
--
-- Dumping data for table `qb_company`
--
...
CREATE TABLE `qb_creditmemo_creditmemoline` (
  ...
  `CreditCardTxnResultInfo_TxnAuthorizationTime` varchar(40) DEFAULT NULL,
...
CREATE TABLE `qb_creditmemo_creditmemolinegroup_creditmemoline` (
  ...
  `CreditCardTxnInfo_CreditCardTxnResultInfo_TxnAuthorizationTime` varchar(40) DEFAULT NULL,
...
CREATE TABLE `quickbooks_config` (
  ...
  `write_datetime` varchar(40) NOT NULL,
  `mod_datetime` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `quickbooks_oauth` (
  ...
  `request_datetime` varchar(40) NOT NULL,
  `access_datetime` varchar(40) DEFAULT NULL,
  `touch_datetime` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `quickbooks_queue` (
  ...
  `msg` text,
  `enqueue_datetime` varchar(40) NOT NULL,
  `dequeue_datetime` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `quickbooks_ticket` (
  ...
  `write_datetime` varchar(40) NOT NULL,
  `touch_datetime` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('quickbooks', '63dbae93fd428318ad3a73be3bcad17250b09825', '', 0, 0, 'e', '2016-08-24 01:33:08', '2016-08-24 02:43:04');
